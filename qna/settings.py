...
ALLOWED_HOSTS = ['qnaeverywhere.herokuapp.com', '127.0.0.1']
...
# command for gathering static files in a single directory
...
# Using WhiteNoise with Djangohttp://whitenoise.evans.io